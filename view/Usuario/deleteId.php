...
?>
            <form action="index.php?modulo=Usuario&acao=deleteId" method="POST">
                ...
                <input type="hidden" name="cpf" pattern="[0-9][0-9][0-9]+.[0-9][0-9][0-9]+.[0-9][0-9][0-9]+-[0-9][0-9]{3,3,3,2}$" title="Digite o cpf" placeholder="999.999.999-99" value="<? echo $data[$i]["cpf"]; ?>" />
